...
- When no action does what you need, make one: write a script or install a program, then run it. You have full access, so you can build any tool you are missing.
