...
- A stop that arrives in the same instant a job finishes on its own is queued and then means "no job to stop"; the engine's existing answer covers it.
