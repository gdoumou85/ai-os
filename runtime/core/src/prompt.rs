...
mod tests {
    ...
    fn system_rules_teach_the_desktop_hand_and_name_no_application() {
        ...
        for w in ["press its menu button", "`Ctrl+S`"] { assert!(SYSTEM.contains(w), "{w}"); }
